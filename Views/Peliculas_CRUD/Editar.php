...
<form action="Actualizar.php" method="post" autocomplete="off" style="margin:20px;">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            ...
            <img src="<?php echo $actualizar_registro[2]; ?>" alt="Imagen actual"
                style="max-width: 200px; margin-bottom: 10px;">
            <?php endif; ?>
            <input type="file" name="imagen" class="form-control" id="inputPassword"
                value="<?php echo $actualizar_registro[2] ?>">
        </div>
    </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="date" name="fecha_publicacion" class="form-control" id="inputPassword"
                value="<?= $actualizar_registro[4] ?>">
        </div>
    </div>
    <div>
