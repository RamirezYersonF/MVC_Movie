                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-9">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="file" name="portada" class="form-control-file form-control-sm" require id="portada    ">
                            </div>
                            <div class="form-group mb-3">
                                <label for="fecha_publicacion" style="padding: 15px 0;">Fecha de
                                    publicación: </label>
                                <input type="date" class="form-control form-control-sm" name="fecha_publicacion" require id="fecha_publicacion">
                            </div>
                            <div class="form-group mb-3">
                                <label for="genero" style="padding: 15px 0;">Género</label>
                                <select class="form-control form-control-sm" name="genero" require id="genero">
                                    <option value="accion">Tipo de Genero</option>
                                    ...
                                    <option value="documental">Otro</option>
                                </select>
                            </div>
